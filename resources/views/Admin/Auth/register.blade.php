...
<body class=" d-flex flex-column">
	...
	<div class="page">
		<div class="container container-tight py-4">
			...
			<form class="card card-md" action="{{route('registerSave')}}" method="POST" autocomplete="off" novalidate>
				@csrf
				<div class="card-body">
					...
					<div class="mb-3">
						...
						<input type="text" maxlength="10" value="{{old('mobile')}}"
					...
					<div class="mb-3">
						...
						<div class="input-group input-group-flat">
							<input type="password" value="{{old('password_confirmation')}}"
								...
								name="password_confirmation" placeholder="Password" autocomplete="off">
						</div>
